...
var routeAuthz = map[string]authzDeclaration{
	...
	"GET /api/v1/jobs/{name}/history":                                 {class: classHandlerInternal, reason: "the handler resolves which namespace the name means and gates on that one; the fixture has no such job so the probe stops at 404"},
	"GET /api/v1/jobs/{name}/resources":                               {class: classHandlerInternal, reason: "the handler resolves which namespace the name means and gates on that one; the fixture has no such job so the probe stops at 404"},
	...
	"GET /api/v1/projects/{name}/jobs/{job}/history":                   {class: classProjectCapability, capability: "kipper.read", scope: scopeNamespace},
	"GET /api/v1/projects/{name}/jobs/{job}/resources":                 {class: classProjectCapability, capability: "kipper.read", scope: scopeNamespace},
	...
	"POST /api/v1/jobs/{name}/trigger":                                 {class: classHandlerInternal, reason: "the handler resolves which namespace the name means and gates on that one; the fixture has no such job so the probe stops at 404"},
	...
	"POST /api/v1/projects/{name}/jobs/{job}/trigger":                {class: classProjectCapability, capability: "kipper.write", scope: scopeNamespace},
	...
	"PUT /api/v1/jobs/{name}/resources":                              {class: classHandlerInternal, reason: "the handler resolves which namespace the name means and gates on that one; the fixture has no such job so the probe stops at 404"},
	...
	"PUT /api/v1/projects/{name}/jobs/{job}/resources":               {class: classProjectCapability, capability: "kipper.write", scope: scopeNamespace},

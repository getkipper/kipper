...
func TestRewriteHostRefs(t *testing.T) {
	rewrites := map[string]string{
		"hrportal-frontend-test.storefront.com": "hrportal-frontend-test.example.com",
		"docuseal-test.storefront.com":          "docuseal-test.example.com",
	}
	...
	tests := []struct {
	...
	}{
		{
			...
			"https://hrportal-frontend-test.example.com/auth/callback",
		},
		{
			"host and port",
			"hrportal-frontend-test.storefront.com:8080",
			"hrportal-frontend-test.example.com:8080",
		},
		{
			"uppercase host is DNS-equivalent and rewritten",
			"https://HRPORTAL-FRONTEND-TEST.STOREFRONT.COM/x",
			"https://hrportal-frontend-test.example.com/x",
		},
		{
		...
		},
		{
			...
			"hrportal-frontend-test.example.com.",
		},
		{
		...
		},
		{
			...
			"https://hrportal-frontend-test.example.com,https://docuseal-test.example.com",
		},
		{
			"bare comma-adjacent hosts",
			"hrportal-frontend-test.storefront.com,docuseal-test.storefront.com",
			"hrportal-frontend-test.example.com,docuseal-test.example.com",
		},
		{
		...
		},
		{
			...
			"postgres://kipper:secret@hrportal-frontend-test.example.com:5432/app",
		},
		{
			"authenticated HTTP URL with userinfo is rewritten",
			"https://user@docuseal-test.storefront.com/path",
			"https://user@docuseal-test.example.com/path",
		},
		{

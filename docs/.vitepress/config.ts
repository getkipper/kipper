  ...
  defineConfig({
    ...
    themeConfig: {
      ...
      nav: [
        ...
        { text: 'Reference', link: '/en/cli-reference' },
        ...
        '/en/': [
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Service UIs & Sharing', link: '/en/service-uis' },
              { text: 'Object Storage', link: '/en/storage' },
              { text: 'Shared Storage', link: '/en/shared-storage' },
            ],
          },
          {
            text: 'Networking & Access',
            items: [
              { text: 'Routing & App Links', link: '/en/routing' },
          ...
          },
          {
            ...
            items: [
              ...
              { text: 'Upgrades & Maintenance', link: '/en/maintenance' },
              ...
              { text: 'AI Backup & Recovery', link: '/en/ai-backups' },
            ],
          },
          {
            text: 'Reference & Development',
            items: [
              { text: 'Installation Reference', link: '/en/installation' },
              { text: 'CLI Reference', link: '/en/cli-reference' },
              { text: 'Configuration', link: '/en/configuration' },
              { text: 'Architecture', link: '/en/architecture' },
              { text: 'Contributing', link: '/en/contributing' },
              { text: 'Kipper vs Other Platforms', link: '/en/comparison' },
            ],
          },
        ],
      },
